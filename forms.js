...
//* Other selected for different service */
document.addEventListener("DOMContentLoaded", function() {
    ...
    const otherServiceInput = otherServiceContainer.querySelector('input');

    serviceTypeSelect.addEventListener('change', function() {
        if (this.value === "Other") {
            otherServiceContainer.style.display = "block";
            otherServiceInput.required = true; // make the input required when "Other" is selected
        } else {
